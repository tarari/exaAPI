...
<body class="flex flex-col h-screen justify-between h-screen overflow-hidden">
    ...
    <div id="search" class="flex flex-col items-center justify-center py-4 w-full">
        <form action="{{route('search')}}" class="flex flex-inline w-full items-center justify-center" method="GET">
            @csrf
            <input class="m-2 p-2 border-2 rounded-md w-1/2" type="text" name="category" placeholder="Search...by Category">
