...
<body class="flex flex-col h-screen justify-between h-screen overflow-hidden">
    <header class="h-10 bg-gray-500 text-center  text-white text-3xl m-2 rounded-sm">
        <a href="https://toniprojects.eu"><img class=" flex-inline w-4 h-4 rounded-full" src="img/toni-boda.png" alt="API.proof"></a>
